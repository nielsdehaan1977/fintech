...
def price_this_home(home_price, expected_sale_price, hurdle_rate, holding_months):
    ...
    if present_value > home_price:
        print("Buy this one, junior analyst! It's worth more than it's selling for.", home_price, present_value)
    # Otherwise, take a pass:
    elif present_value < home_price:
        print("Don't buy this, as it's offered at a price higher than what it's worth.", home_price, present_value)
    # Bonus! The edge case:
    elif present_value == home_price:
        print(
            "Breakeven case! You can expect to earn exactly your hurdle rate on this deal.", home_price, present_value
        )
