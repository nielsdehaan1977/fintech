...
for loan in loan_costs:
    ...
    if fair_value >= loan:
        print(f"Loannumber {loan_number} PV is {loan} and is worth at least the cost to buy it")
    else:
        print(f"Loannumber {loan_number} PV is {loan} and is too expensive and not worth the price")
